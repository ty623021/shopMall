...
public class AbListViewHeader extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        //从包里获取的箭头图片
//		arrowImage = Abf.getBitmapFromSrc("image/arrow.png");
        imageId = R.drawable.pull_arrow;

//		arrowImageView.setImageBitmap(arrowImage);
        arrowImageView.setImageResource(imageId);
...
//		indeterminateDrawable=this.getResources().getDrawable(R.drawable.progress_circular);
